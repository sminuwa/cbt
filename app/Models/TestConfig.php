...
class TestConfig extends Model
{
	...
	{
		return $this->hasMany(Endorsement::class, 'test_id');
	}

	public function exams_dates()
	{
		return $this->hasMany(ExamsDate::class, 'test_id');
	}

	public function feed_back()
	{
		return $this->hasMany(FeedBack::class, 'test_id');
	}

	public function schedulings()
	{
		return $this->hasMany(Scheduling::class, 'test_id');
	}

	public function test_compositors()
	{
		return $this->hasMany(TestCompositor::class, 'test_id');
	}

	public function test_invigilators()
	{
		return $this->hasMany(TestInvigilator::class, 'test_id');
	}
	...
	{
		return $this->hasMany(TimeControl::class, 'test_id');
	}
}
