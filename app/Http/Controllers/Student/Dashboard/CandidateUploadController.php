...
//        $rows = Excel::toArray(new Upload::class, $file)[0];
    ...
    public function imageIndex()
    {
        ...
        return view('pages.admin.toolbox.candidate_image_upload',compact('candidate_pictures'));
    }
    ...
    public function invigilator()
    {
        ...
        return view('pages.admin.toolbox.invigilator_panel',compact('testConfigs','examTypes','candidateTypes','candidates'));
    }
