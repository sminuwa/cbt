...
class ReportController extends Controller
{
    ...
    public function generateReport(Request $request)
    {
        try {
            ...
            ->groupBy('candidates.id', 'scores.scheduled_candidate_id')
            ->get();
            ...
            foreach($candidates as $candidate){
                if($candidate->P1 < 50 && $candidate->P1 > 0) $statistics['P1_below_50_count'] ++; 
                if($candidate->P2 < 50 && $candidate->P2 > 0) $statistics['P2_below_50_count'] ++; 
                if($candidate->P3 < 50 && $candidate->P3 > 0) $statistics['P3_below_50_count'] ++; 
                if($candidate->PE < 50 && $candidate->PE > 0) $statistics['PE_below_50_count'] ++; 
                if($candidate->PA < 10 && $candidate->PA > 0) $statistics['PA_below_50_count'] ++;

                if($candidate->P1 >= 50) $statistics['P1_above_50_count'] ++;
                if($candidate->P2 >= 50) $statistics['P2_above_50_count'] ++;
                if($candidate->P3 >= 50) $statistics['P3_above_50_count'] ++;
                if($candidate->PE >= 50) $statistics['PE_above_50_count'] ++;
                if($candidate->PA >= 10) $statistics['PA_above_50_count'] ++;
            }
