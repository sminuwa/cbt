    ...
    <div class="modal fade custom-modal" id="add_new_subject">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="{{route('admin.toolbox.subject.store')}}" method="post">
                    @csrf
    ...
    <script>
        $(document).ready(function () {
            ...
            $(document).on('click', '.add', function () {
                ...
                $('#form').attr('action', '{{route('admin.toolbox.subject.store')}}')
            })
            ...
            $('#btnDelete').on('click', function () {
                ...
                console.log(id)
                $.get('{{route('admin.toolbox.subject.delete',['subject' => ':id'])}}'.replace(':id', id),
                    function (response) {
