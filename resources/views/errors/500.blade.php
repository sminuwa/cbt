  ...
  <body>
    ...
    <div class="page-wrapper compact-wrapper" id="pageWrapper">
      ...
      <div class="error-wrapper">
        <div class="container"><img class="img-100" src="{{  asset('candidate/assets/images/other-images/sad.png') }}" alt="">
          ...
          <div><a class="btn btn-primary btn-lg" href="{{ route('candidate.auth.page') }}">BACK</a></div>
        </div>
      </div>
      <!-- error-500 end-->
    </div>
